// Dafny program Endo.dfy compiled into C#
...
// Command Line Options: /home/alexis51151/Ecole/Rice University/COMP-517/comp517-project/src/dafny/Endo.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin/Endo
// Endo.dfy
...
class Capability {
  ...
  constructor setCapability(subspace: seq<int>, files: seq<int>)
...
namespace _module {
  ...
  public partial class Endokernel {
    ...
    public Endoprocess createEndoprocess(Capability capability, Instruction instruction)
    {
      ...
      Endoprocess _nw0 = new Endoprocess();
      _nw0.__ctor(this.nextPid, capability.subspace, instruction, this);
      endoprocess = _nw0;
    ...
    public void trap(Instruction instruction)
    {
      if (!(this.instructionMap).Contains((instruction))) {
        ...
        Capability _150_capability;
        _150_capability = Dafny.Map<Instruction, Capability>.Select(this.instructionMap,instruction);
        Endoprocess _151_endoprocess = default(Endoprocess);
        if (!(this.capabilities).Contains((_150_capability))) {
          Endoprocess _out0;
          _out0 = (this).createEndoprocess(_150_capability, instruction);
          _151_endoprocess = _out0;
        } else {
          _151_endoprocess = Dafny.Map<Capability, Endoprocess>.Select(this.capabilities,_150_capability);
        }
        ...
        (_151_endoprocess).exec(instruction);
      }
    }
    public bool trapEndoprocess(Instruction instruction, BigInteger endoId)
    {
      ...
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("Trapping instruction "));
      Dafny.Helpers.Print(instruction);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" from Endoprocess in Endokernel\n"));
      if (!(this.instructionMap).Contains((instruction))) {
        ret = false;
        Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("trapEndoprocess error: no policy for this instruction\n"));
      } else {
        Capability _152_capability;
        _152_capability = Dafny.Map<Instruction, Capability>.Select(this.instructionMap,instruction);
        if (!(this.capabilities).Contains((_152_capability))) {
          ret = false;
          ...
          Endoprocess _153_endoprocessExpected;
          _153_endoprocessExpected = Dafny.Map<Capability, Endoprocess>.Select(this.capabilities,_152_capability);
          if (!(this.endoprocesses).Contains((endoId))) {
            ...
            if ((this.syscalls).Contains((instruction))) {
              if (__default.isWriteInstruction(instruction)) {
                bool _154_ret;
                bool _out1;
                _out1 = __default.writeImplementation((instruction).dtor_fd, (instruction).dtor_addr, (instruction).dtor_size, this.instructionMap, instruction);
                _154_ret = _out1;
                if (_154_ret) {
              ...
              ret = false;
              Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("trapEndoprocess error: syscall unknown\n"));
            }
          }
        }
      }
    ...
    public void __ctor(Kernel kernel)
    {
      ...
      Capability _155_capability;
      Capability _nw1 = new Capability();
      _nw1.setCapability(Dafny.Sequence<BigInteger>.FromElements(BigInteger.Zero), Dafny.Sequence<BigInteger>.FromElements(BigInteger.Zero));
      _155_capability = _nw1;
      Instruction _156_instruction;
      _156_instruction = @Instruction.create_Write(BigInteger.Zero, BigInteger.Zero, new BigInteger(2));
      (this).instructionMap = Dafny.Map<Instruction, Capability>.FromElements(new Dafny.Pair<Instruction, Capability>(_156_instruction, _155_capability));
      (this).kernel = kernel;
  ...
  public partial class Endoprocess {
    ...
    public void exec(Instruction instruction)
    {
      ...
      bool _157_ret;
      bool _out2;
      _out2 = (this.endokernel).trapEndoprocess(instruction, this.id);
      _157_ret = _out2;
    }
  }
  ...
  public partial class __default {
    public static bool isWriteInstruction(Instruction i) {
      ...
      if (_source0.is_Write) {
        BigInteger _158___mcc_h0 = ((Instruction_Write)_source0).fd;
        BigInteger _159___mcc_h1 = ((Instruction_Write)_source0).addr;
        BigInteger _160___mcc_h2 = ((Instruction_Write)_source0).size;
        BigInteger _161_size = _160___mcc_h2;
        BigInteger _162_addr = _159___mcc_h1;
        BigInteger _163_fd = _158___mcc_h0;
        return true;
      } else {
        BigInteger _164___mcc_h3 = ((Instruction_Read)_source0).addr;
        BigInteger _165_addr = _164___mcc_h3;
        return false;
      }
    }
    public static bool getImplementation(Syscall sc, Dafny.IMap<Instruction,Capability> instructionMap, Instruction instruction)
    {
      ...
      if (_source1.is_Write) {
        BigInteger _166___mcc_h0 = ((Syscall_Write)_source1).fd;
        BigInteger _167___mcc_h1 = ((Syscall_Write)_source1).addr;
        BigInteger _168___mcc_h2 = ((Syscall_Write)_source1).size;
        {
          BigInteger _169_size = _168___mcc_h2;
          BigInteger _170_addr = _167___mcc_h1;
          BigInteger _171_fd = _166___mcc_h0;
          bool _out3;
          _out3 = __default.writeImplementation(_171_fd, _170_addr, _169_size, instructionMap, instruction);
          ret = _out3;
        }
      } else {
        BigInteger _172___mcc_h3 = ((Syscall_Read)_source1).addr;
        {
          BigInteger _173_addr = _172___mcc_h3;
          ret = false;
        }
      }
      return ret;
    }
    public static bool writeImplementation(BigInteger fd, BigInteger addr, BigInteger size, Dafny.IMap<Instruction,Capability> instructionMap, Instruction instruction)
    {
      bool ret = false;
      if ((size).Sign == -1) {
        ret = false;
  ...
  public partial class Capability {
    ...
    public void setCapability(Dafny.ISequence<BigInteger> subspace, Dafny.ISequence<BigInteger> files)
    {
      (this).subspace = subspace;
      (this).files = files;
    }
  ...
  public partial class Kernel {
    ...
    public void exec(Syscall syscall)
    {
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("Executing syscall "));
      Dafny.Helpers.Print(syscall);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" in kernel\n"));
    }
    public void __ctor()
    {
    }
  ...
  public abstract class Instruction {
    public Instruction() { }
    private static readonly Instruction theDefault = create_Write(BigInteger.Zero, BigInteger.Zero, BigInteger.Zero);
  ...
  public class Instruction_Write : Instruction {
    ...
    public Instruction_Write(BigInteger fd, BigInteger addr, BigInteger size) {
      this.fd = fd;
      this.addr = addr;
      this.size = size;
    }
  ...
  public abstract class Syscall {
    public Syscall() { }
    private static readonly Syscall theDefault = create_Write(BigInteger.Zero, BigInteger.Zero, BigInteger.Zero);
    public static Syscall Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<Syscall> _TYPE = new Dafny.TypeDescriptor<Syscall>(Syscall.Default());
    public static Dafny.TypeDescriptor<Syscall> _TypeDescriptor() {
      return _TYPE;
    }
    ...
    public BigInteger dtor_addr {
      get {
        var d = this;
        if (d is Syscall_Write) { return ((Syscall_Write)d).addr; }
        return ((Syscall_Read)d).addr; 
      }
    }
    public BigInteger dtor_size {
      get {
  ...
  public class Syscall_Write : Syscall {
    public readonly BigInteger fd;
    public readonly BigInteger addr;
    public readonly BigInteger size;
    public Syscall_Write(BigInteger fd, BigInteger addr, BigInteger size) {
      this.fd = fd;
      this.addr = addr;
      this.size = size;
    }
    public override bool Equals(object other) {
      var oth = other as Syscall_Write;
      return oth != null && this.fd == oth.fd && this.addr == oth.addr && this.size == oth.size;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
